...
void Duty_Set()
{
    ...
    bb.dutyoutput_PID = float_constrain(duty_cyc1, 0 ,2.0f * bb.duty_max_);//0 -- 1.2f
...
{   
    ...
    dutyoutput = bb.dutyoutput_PID + (duty_voltage_gain_ref - duty_voltage_gain_measure) * kp_ffb1;
    // dutyoutput = 0.25;
